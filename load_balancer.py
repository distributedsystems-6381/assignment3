...
def load_balance_brokers(target_brokers_count):
    ...
    elif target_brokers_count > 0 and target_brokers_count < len(
            brokers) and activate_broker_count < target_brokers_count:
            ...
            for topic in published_topics:
                ...
                if topic_node_value is not None:
                    ...
                    if len(topic_pubs) > 0 and len(topic_subs) > 0:
                        zkclient.set_node_value(topic_root_path + "/" + topic,
